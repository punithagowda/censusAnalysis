<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm5.aspx.cs" Inherits="census.WebForm5" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <h3>Prediction in Unemployement Rate</h3>
            <br />
            <br />
...
<br />
     ...
     <br />
        <asp:Chart ID="Chart1" runat="server">
            ...
            <br />
            <br />
            <asp:Label ID="Label2" runat="server" Text="X-axis : Years and Y-axis: Percentage"></asp:Label>
            <br />
            <br />
        </div>
