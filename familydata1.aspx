<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="familydata1.aspx.cs" Inherits="census.familydata1" %>
        ...
        <table align="center" class="auto-style5">
            ...
            <tr>
                ...
                <asp:DropDownList ID="DropDownList1" runat="server">
                    <asp:ListItem>Relationship with Head</asp:ListItem>
                    <asp:ListItem>Spouse</asp:ListItem>
                    <asp:ListItem>Sibling</asp:ListItem>
                    <asp:ListItem>Son/Daughter</asp:ListItem>
...
<asp:DropDownList ID="DropDownList3" runat="server">
    ...
    <asp:ListItem>Central governament</asp:ListItem>
                ...
                <td  class="auto-style2">
                    <asp:Button ID="Button2" runat="server" cssclass="btn--form" Text="Add Member" BorderStyle="None" OnClick="Button2_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button3" runat="server" cssclass="btn--form" Text="Next" BorderStyle="None" OnClick="Button3_Click" />
                </td>
            </tr>
